...
from services.size_predictor import SizePredictorService
...
class SmartFitPipeline:
    ...
    def __init__(self) -> None:
        ...
        self.quality_checker = CaptureQualityService()
        self.size_predictor = SizePredictorService(model_path=settings.model_path)
        ...
        self.virtual_tryon = VirtualTryOnService(assets_dir=settings.tryon_assets_dir)
